...
+ mRNA attaches to a ribosome and tRNA collects [[Amino acids]] from the [[cytoplasm]] and carries them to the ribosome. tRNA is a single stranded molecule with a  binding site at one end thus it can only carry one type of amino acid, and a triplet of bases at the other
